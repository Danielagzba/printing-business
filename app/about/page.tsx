    ...
    <div className="flex flex-col pt-24">
      ...
      <section className="relative w-full h-[50vh] overflow-hidden bg-neutral-100">
        ...
        <div className="container relative z-10 flex flex-col items-center justify-center h-full text-center px-4">
          <h1 className="font-serif text-4xl md:text-6xl font-light tracking-tight mb-6">Our Story</h1>
          <p className="text-lg md:text-xl max-w-2xl text-neutral-600">
            Crafting beautiful printed pieces with passion and precision since 2010
          </p>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="container px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="font-serif text-3xl font-light mb-6">The Beginning</h2>
              <div className="space-y-4 text-neutral-600 leading-relaxed">
                <p>
                  Artisan Press began in 2010 when founder Eleanor Wright discovered a vintage letterpress in an old
                  print shop that was closing down. Fascinated by the history and craftsmanship of traditional printing
                  techniques, she purchased the press and began a journey to master this time-honored art form.
                </p>
                <p>
                  What started as a passion project in a small studio space quickly grew as people discovered the unique
                  quality and character that only letterpress printing can provide. In an increasingly digital world, the
                  tactile nature and artistic quality of our printed pieces resonated with those seeking something more
                  personal and distinctive.
                </p>
                <p>
                  Over the years, we've expanded our techniques to include foil stamping, embossing, and other specialty
                  printing methods, while remaining true to our commitment to quality, craftsmanship, and artistic
                  expression. Today, Artisan Press is a boutique printing studio creating beautiful, thoughtfully crafted
                  printed materials for clients who value the art of print.
                </p>
              </div>
            </div>
        ...
        <div className="container px-4">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <p className="text-neutral-600 leading-relaxed">
              At Artisan Press, we believe in the power of print to create meaningful connections in an increasingly
              digital world. Our approach combines respect for traditional craftsmanship with contemporary design
              sensibilities to create printed pieces that are both timeless and relevant.
            </p>
          </div>
      ...
      <section id="process" className="py-20 bg-white">
        <div className="container px-4">
          <h2 className="font-serif text-3xl font-light mb-16 text-center">Our Process</h2>
            ...
            {[
              ...
              >
                ...
                <div className="w-full md:w-1/2 space-y-4">
                  <span className="font-serif text-6xl text-neutral-200">{step.number}</span>
      ...
      <section id="team" className="py-20 bg-neutral-50">
        <div className="container px-4">
          <h2 className="font-serif text-3xl font-light mb-16 text-center">Meet Our Team</h2>
        ...
        <div className="container px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="order-2 md:order-1">
              <h2 className="font-serif text-3xl font-light mb-6">Our Studio</h2>
              <div className="space-y-4 text-neutral-600 leading-relaxed">
                <p>
                  Our printing studio is a blend of history and innovation, housing our collection of vintage presses
                  alongside modern equipment. It's a space where traditional craftsmanship meets contemporary design,
                  allowing us to create printed pieces with character and quality that can't be replicated digitally.
                </p>
                <p>
                  The heart of our studio is our collection of letterpress equipment, including a restored Chandler &
                  Price press from 1915 and a Heidelberg Windmill from the 1960s. These machines, with their distinctive
                  rhythmic sounds and mechanical precision, are operated by our skilled printers who have mastered the
                  art of achieving the perfect impression.
                </p>
                <p>
                  We welcome visitors to our studio by appointment, where you can see our presses in action and
                  experience firsthand the craftsmanship that goes into every printed piece we create.
                </p>
              </div>
              <Button
                asChild
      ...
      <section className="py-20 bg-primary text-white">
        <div className="container px-4 text-center">
          <h2 className="font-serif text-3xl md:text-4xl font-light mb-6">Work With Us</h2>
          <p className="text-lg max-w-2xl mx-auto mb-10 opacity-90">
            Ready to create something beautiful together? Contact us to discuss your project and discover how our
            artisanal approach to printing can bring your vision to life.
          </p>
          <Button asChild size="lg" variant="outline" className="text-white border-white hover:bg-amber-800 rounded-none px-8">
